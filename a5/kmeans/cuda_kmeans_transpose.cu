						...
						int blockSize)  
{
    ...
    // printf("Initial Initial cluster centers:\n", loop);
    ...
    const unsigned int clusterBlockSharedDataSize = numThreadsPerClusterBlock*sizeof(int);
    ...
    checkCuda(cudaMemcpy(deviceObjects, dimObjects[0], //pointer to first element of the array
